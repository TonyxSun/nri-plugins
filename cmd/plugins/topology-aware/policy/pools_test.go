...
// TestFailOpenMemoryAdmission is the policy-level regression for the memory fail-open.
...
// TestFailOpenDoesNotMaskCPUFailure verifies the memory fail-open does
...
// TestFailOpenStillAppliesCPUPinning verifies that when memory admission
